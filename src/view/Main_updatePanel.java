...
import control.Main_UpdateAction;
...
public class Main_updatePanel extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Main_updatePanel frame = new Main_updatePanel();
	...
	public Main_updatePanel() {
		...
		ActionListener ac = new Main_UpdateAction(this);
		...
		btnUpdate.setBounds(465, 346, 89, 27);
	...
	public void Update() {
		Employee emp = GetInfor();
		this.employee.assign(emp);
		mainPanel.updateIntoTable(employee);
	}
	...
	public void ClearForm() {
		...
		this.textRate.setText(Department.getDepartbyID(cbDepart.getSelectedIndex()).getSalaryRate() + "");
